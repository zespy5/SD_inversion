...
class dualcondition_SDXL(StableDiffusionXLPipeline):
    ...
    def __call__(
        ...
        guidance_scale: List[float] = [1.0,5.0],
...
if __name__=="__main__":
    ...
    guid=Path(f'diff[1,2]_guid_results')
    ...
    for p in prompts:
        prompt2 = p
        prompt = "a photo of a dog is in front of the building"
        
        image = pipe(prompt=prompt,
                    prompt_2=prompt2,
                    negative_prompt='ugly, blurry, low res, unrealistic',
                    num_images_per_prompt=10, 
                    guidance_scale=[1.1,2.0]).images
        whatobj=guid/p
